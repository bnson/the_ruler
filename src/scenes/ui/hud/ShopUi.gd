...
@onready var player_item_grid: GridContainer = $Main/Container/HBoxContainer/Panel1/MarginContainer/VBoxContainer/ScrollContainer/PlayerItemGrid
@onready var npc_item_grid: GridContainer = $Main/Container/HBoxContainer/Panel2/MarginContainer/VBoxContainer2/NpcItemGrid
